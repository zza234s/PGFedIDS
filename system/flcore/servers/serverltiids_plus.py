...
import math
import numpy as np
from flcore.clients.clientLTIIDS_plus import clientLTIIDS_Plus
from flcore.servers.serverbase import Server
from threading import Thread
from collections import defaultdict
from utils.data_utils import read_client_data
from utils.result_utils import plot_acc_curve
import time
import copy
import os
import h5py
...
class FedLTIIDS_Plus(Server):
    def __init__(self, args, times):
        super().__init__(args, times)

        # select slow clients
        self.set_slow_clients()
        self.set_clients(clientLTIIDS_Plus)
        ...
        for i in range(self.global_rounds + 1):
            ...
            for client in self.selected_clients:
                ...
                if self.global_protos is not None and self.use_ensemble:
                    client.train_for_ensemble_weight()
